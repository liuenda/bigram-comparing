...
def find_mapping(input_filename,k):
	...
	for N_en in range(1,k+1):
		...
		# SAve the each mapping resutls with similarity (and centroid) into a list of list
		mapping_list.append([N_en,combin_list[sim_bestIndex],max(sim_list)])
