...
logout=open('./output/Log/log_jp.txt','w')
model_name='../Modeling/model-jp/W2Vmodle.bin'
input_filename='./input/keyword_103_jp.txt'
output_filename2=open('./output/Log/bad_list_jp.txt','w')
output_filename='output/vecs_jp.csv'
