...
def save_centroid(kmeans_centers,lang_name):
	...
	centroid_filename = output_dir+"centroid_" + lang_name + str(k) + ".csv"
...
if __name__ =="__main__":
	...
	kmeans_en=SphericalKMeans(init='k-means++',n_clusters=k,n_init=1)
	...
	kmeans_jp=SphericalKMeans(init='k-means++',n_clusters=k,n_init=1)
